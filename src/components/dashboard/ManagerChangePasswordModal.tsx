...
interface ManagerChangePasswordModalProps {
  isOpen: boolean;
  onClose: () => void;
  user: Profile | null;
}

export default function ManagerChangePasswordModal({
  isOpen,
  onClose,
  user,
}: ManagerChangePasswordModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    toast.success(`Password updated for "${user.full_name || user.email}"`);
    setPassword("");
    setConfirm("");
    onClose();
  };
  ...
  return (
    <div
      role="dialog"
      aria-modal="true"
      aria-labelledby="mgr-pw-modal-title"
    ...
    >
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md">
        <div className="flex items-center justify-between p-6 border-b border-gray-100">
          <div>
            <h2 id="mgr-pw-modal-title" className="text-xl font-bold text-gray-900 font-heading">
              Set Password
            </h2>
