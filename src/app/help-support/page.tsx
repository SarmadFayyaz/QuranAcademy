...
const contactMethods = [
  ...
  },
  {
    icon: Phone,
    title: "Phone (USA)",
    desc: "Call our US number anytime.",
    value: "+1 (415) 725-6147",
  ...
  },
  {
    ...
    value: "info@hasnainquranacademy.com",
    href: "mailto:info@hasnainquranacademy.com",
      ...
      <section className="section-padding bg-white">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10">
          ...
          <div className="lg:w-2/3 space-y-16">
            ...
            <div>
              <div className="fade-up p-7 rounded-2xl bg-gradient-to-br from-primary-50 to-white border border-primary-100">
            ...
            {/* Contact Methods */}
            <div>
              <h2 className="text-2xl md:text-3xl font-bold font-heading text-gray-900 mb-2">Get in <span className="text-primary-600">Touch</span></h2>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {contactMethods.map((m, i) => (
                  <a
                    ...
                    className="fade-up flex items-start gap-4 p-5 rounded-2xl bg-gray-50 border border-gray-100 hover:shadow-md hover:border-primary-200 transition-all duration-300 group"
                  >
                    <div className={`w-12 h-12 rounded-xl ${m.color} flex items-center justify-center shrink-0`}>
                      <m.icon size={22} />
                    </div>
                    <div>
                      <h3 className="font-bold text-gray-900 mb-0.5 group-hover:text-primary-600 transition-colors">{m.title}</h3>
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {whyUs.map((item, i) => (
                  <div key={i} className="fade-up flex items-start gap-4 p-5 rounded-2xl bg-gray-50 border border-gray-100 hover:shadow-md transition-all duration-300">
            ...
            {/* FAQ */}
            <div>
              <h2 className="text-2xl md:text-3xl font-bold font-heading text-gray-900 mb-2">Frequently Asked <span className="text-primary-600">Questions</span></h2>
              <p className="text-gray-500 mb-8">Find quick answers to common questions about our academy.</p>
              <div className="space-y-3">
                {faqs.map((faq, i) => (
                  <details
                    key={i}
                    className="fade-up group rounded-2xl border border-gray-100 hover:border-primary-200 transition-all duration-300 overflow-hidden"
                  >
                    <summary className="flex items-center justify-between gap-4 p-5 cursor-pointer list-none [&::-webkit-details-marker]:hidden">
                      ...
                      <ChevronDown className="text-gray-400 shrink-0 transition-transform group-open:rotate-180" size={18} />
                    </summary>
